 ...
 * @author rahul
 */
public class TakeCoueses extends javax.swing.JFrame {

    /**
     * Creates new form TakeCoueses
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Course Registration Portal");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Subject id(Taken)", "Subject name(Taken)"
            }
        ));
    ...
    void takeCource() throws ClassNotFoundException, SQLException {
        ...
        rs = connect.rs;
        while (rs.next()) {
            model.insertRow(model.getRowCount(), new Object[]{rs.getString("course_id"), rs.getString("course_name")});
        ...
        if (model.getRowCount() >= 1) {
            ...
            if (count == 0) {
                try {
                    ...
                    String query = "SELECT `course_name` FROM `tb_course` WHERE `course_id`='" + SubjectCode + "';";
                    connect.executeSQL(query);
                    rs = connect.rs;
                    while (rs.next()) {
                        rs.getString("course_name");
                        System.out.println(rs.getString("course_name"));
                        model.insertRow(model.getRowCount(), new Object[]{SubjectCode, rs.getString("course_name")});
                    }
                    connect.disconnect();
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    System.out.println(rs.getString("course_name"));
                    model.insertRow(model.getRowCount(), new Object[]{SubjectCode, rs.getString("course_name")});
                    // String query1 = "INSERT INTO `student_course`(`id`, `course_id`) VALUES ('" + Id + "','" + SubjectCode + "');";
                    //  connect.executeSQL(query1);
                }
                connect.disconnect();
            } catch (SQLException e) {
                System.out.println("ErroR : " + e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeCoueses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TakeCoueses().setVisible(true);
            }
        });
    }
